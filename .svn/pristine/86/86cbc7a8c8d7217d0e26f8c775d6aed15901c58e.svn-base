public class Strings 
{
	public static readonly string[] ecosystemTutorialStrings =
	{
		...
		//Not nextable
		//Challenge 1
		"Now that you've learned the basics. Obtain an environment score of 3000, with atleast 3 species.",

		//8
		//Not nextable
		//Challenge 2
		"Obtain an environment score of ???, with atleast 4 species.",

		//9
		//Not nextable
		//Challenge 3
		"Obtain an environment score of ???, with atleast 5 species.",

		//10
		"Obtain an environment score of ???, with atleast 6 species.",
